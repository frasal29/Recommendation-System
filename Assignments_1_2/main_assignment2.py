...
def main():
    ...
    group.average_aggregation("output/dataset_with_also_predictions.csv", users)
    group.least_misery_aggregation("output/dataset_with_also_predictions.csv", users)

    # Print the top 10 records from the aggregation tables
    group.print_top_10_aggregations("output/average_aggregation.csv", movie_data, "averageAggregation")
    group.print_top_10_aggregations("output/least_misery_aggregation.csv", movie_data, "leastMiseryAggregation")
    
    

    ''' PART 2 WITH DISAGREEMENT '''

    file_path = 'output/dataset_with_also_predictions.csv'
    ...
    output_file_path = 'output/scores_with_disagreement.csv'
