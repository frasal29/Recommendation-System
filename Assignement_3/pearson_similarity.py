def pearson_similarity(user_id, data, min_common_movies=5, min_pearson_score=0.6):
    ...
    for other_user_id in data['userId'].unique():
        ...
        if other_user_id != user_id:
            ...
            # If there are no common movieIds or the number of common movies is less than min_common_movies, move to the next user
            ...
            # Consider the correlation only if it exceeds the minimum threshold
            if correlation >= min_pearson_score:
